  ...
  Baseuser.signup = async function (
    ...
    try {
      ...
      if (users.length > 0) {
        ...
        var AccessRightCategory = Baseuser.app.models.AccessRightCategory;
        var AccessRightMethod = Baseuser.app.models.AccessRightMethod;
        var AccessRight = Baseuser.app.models.AccessRight;
