  ...
  */
  /*
    ...
    AccessRightMethod.create([
      { name: "create", access: true },
      { name: "read", access: true},
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "viewall", parentMethod: "read", access: true },
      { name: "saverights", parentMethod: "update", access: true },
      { name: "create", access: true },
      { name: "read", editable: false, access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "viewall", access: true },
      { name: "create", parentMethod: "viewall", access: true },
      { name: "read", parentMethod: "viewall", access: true },
      { name: "update", parentMethod: "viewall", access: true },
      { name: "delete", parentMethod: "viewall", access: true },
      { name: "saveuserrights", parentMethod: "viewall", access: true },
      { name: "create", access: true },
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      ...
      { name: "read", editable: false, access: true },
      { name: "update", access: true },
      { name: "delete", editable: false, access: true },
      { name: "create", access: true }, //event
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", access: true },
      ...
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", access: true }, //customer info
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", access: true }, //customer cat
      { name: "read", editable: false, access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", parentModel: "Customer", parentMethod: "create", access: true },
      { name: "read", parentModel: "Customer", parentMethod: "read", access: true },
      { name: "update", parentModel: "Customer", parentMethod: "update", access: true },
      { name: "delete", parentModel: "Customer", parentMethod: "delete", access: true },
      { name: "create", parentModel: "Customer", parentMethod: "create", access: true },
      { name: "read", parentModel: "Customer", parentMethod: "read", access: true },
      { name: "update", parentModel: "Customer", parentMethod: "update", access: true },
      { name: "delete", parentModel: "Customer", parentMethod: "delete", access: true },
      { name: "create", access: true }, //account
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", access: true },
      ...
      { name: "delete", access: true },
      { name: "create", access: true },
      { name: "read", parentModel: "Lead", parentMethod: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", parentModel: "LeadIndustry", parentMethod: "create", access: true },
      { name: "read", parentModel: "Lead", parentMethod: "read", access: true },
      { name: "update", parentModel: "LeadIndustry", parentMethod: "update", access: true },
      { name: "delete", parentModel: "LeadIndustry", parentMethod: "delete", access: true },
      { name: "create", parentModel: "LeadIndustry", parentMethod: "create", access: true }, //lead status
      { name: "read", parentModel: "Lead", parentMethod: "read", access: true },
      { name: "update", parentModel: "LeadIndustry", parentMethod: "update", access: true },
      { name: "delete", parentModel: "LeadIndustry", parentMethod: "delete", access: true },
      { name: "create", access: true }, //deal
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", access: true }, //deal select list
      { name: "read", access: true },
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", parentModel: "Deal", parentMethod: "create", access: true },
      { name: "read", parentModel: "Deal", parentMethod: "read", access: true },
      { name: "update", parentModel: "Deal", parentMethod: "update", access: true },
      { name: "delete", parentModel: "Deal", parentMethod: "delete", access: true },
      { name: "create", parentModel: "Deal", parentMethod: "create", access: true },
      { name: "read", parentModel: "Deal", parentMethod: "read", access: true },
      { name: "update", parentModel: "Deal", parentMethod: "update", access: true },
      { name: "delete", parentModel: "Deal", parentMethod: "delete", access: true },
      ...
      { name: "update", access: true },
      { name: "delete", access: true },
      { name: "create", parentModel: "Quotation", parentMethod: "create", access: true },
      { name: "read", parentModel: "Quotation", parentMethod: "read", access: true },
      { name: "update", parentModel: "Quotation", parentMethod: "update", access: true },
      { name: "delete", parentModel: "Quotation", parentMethod: "delete", access: true }
